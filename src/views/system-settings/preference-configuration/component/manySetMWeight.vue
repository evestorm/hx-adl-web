    ...
    <el-form ref="form" :inline="true" :model="dataItem" label-width="80px">
      ...
      <el-form-item label="包散类型:">
        <el-select v-model="dataItem.packagingType" size="small" placeholder="请选择" value="S">
          ...
          <el-option label="Z、砖类" value="T"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label>
        <el-button plain round size="small" @click="addItem('poundMultiM')">添加</el-button>
      </el-form-item>
    </el-form>
    <el-table
      border
    ...
    >
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <div class="delete" @click="deleteData(scope.row.idSyn, 'poundMultiM')">删除</div>
        </template>
      </el-table-column>
    </el-table>
  </div>
...
export default {
  ...
  data() {
    return {
      dataItem: { idInfo: "", name: "", typeInfo: "poundMultiM" },
    };
  },
  methods: {
